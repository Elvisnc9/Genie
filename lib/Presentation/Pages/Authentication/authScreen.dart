      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Image.asset('assets/icons/Name.png', color: Colors.white, height: 25.h, width: 50.w),
                ...
                child: Column(
                  children: [
                    ...
                    SocialButton(
                      ...
                      logo: 'assets/icons/email_logo.png',
                      authenticate: () {},
                    ),
                  ],
                ),
                ...
                children: <TextSpan>[
                  TextSpan(
                    ...
                    style: TextStyle(
                      ...
                      color:
                          AppColors.berry, 
                          height: 1.4// Different style (bold)         // Different color// Add a decoration
                    ),
                  ),
                ],
              ),
...
class SocialButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: ButtonWidget(
        push: authenticate,
        color: AppColors.mintty,
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Image.asset(logo, height: 3.5.h, color: Colors.black,),

            SizedBox(width: 0.1.h),

            Text(
              title,
              style: texttheme.bodyMedium?.copyWith(color: AppColors.dark, fontWeight: FontWeight.bold),
            ),
          ],
        ),
      ),
    ...
    return SizedBox(
      ...
      child: Center(
        child: DefaultTextStyle(
          textAlign: TextAlign.center,
          style: TextStyle(
            // This sets the base style for all texts
            fontSize: 18.sp,
